...
rm -rf $MANIFEST_REPO && git clone https://$GIT_TOKEN@$MANIFEST_HOST/$MANIFEST_USER/$MANIFEST_REPO.git
...
git push https://$GIT_TOKEN@$MANIFEST_HOST/$MANIFEST_USER/$MANIFEST_REPO.git
